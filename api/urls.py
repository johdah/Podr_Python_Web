...
import api
from api.views import EpisodeViewSet, PodcastViewSet, UserEpisodeViewSet, UserPodcastViewSet, CategoryViewSet, PodcastCategoriesViewSet
...
podcastcategories_list = PodcastCategoriesViewSet.as_view({
    'get': 'list',
})
podcastcategories_detail = PodcastCategoriesViewSet.as_view({
    'get': 'retrieve',
})
...
urlpatterns = format_suffix_patterns(patterns('api.views',
    ...
    url(r'^v1/category/$', category_list, name="category-list"),
    url(r'^v1/category/(?P<pk>[0-9]+)/$', category_detail, name="category-detail"),
    ...
    url(r'^v1/podcastcategories/$', podcastcategories_list, name="podcastcategories-list"),
    url(r'^v1/podcastcategories/(?P<pk>[0-9]+)/$', podcastcategories_detail, name="podcastcategories-detail"),
